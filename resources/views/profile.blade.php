...
@section('content')
    <div class="d-flex justify-content-center">
        <div class="card mb-3" style="max-width: 600px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="{{ asset('images/static/user-profile.png') }}" class="img-fluid rounded-start p-2"
                        alt="user-profile">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <div class="data mt-3">
                            <p class="card-text m-0"> <strong>NIS/NIP</strong> : {{ Auth::user()->uuid }}</p>
            ...
            <div class="row p-3 pt-0">
                <div class="col-md-6"><button data-bs-toggle="modal" data-bs-target="#modalLogout" type="button"
                        class="btn btn-danger btn-l w-75">Kembali</button></div>

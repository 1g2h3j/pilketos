...
<?php endif; ?>
    ...
    <?php if(! $slot->isEmpty()): ?>
        <div <?php echo e($attributes->merge(['class' => $makeCardBodyClass()])); ?>>
            <?php echo e($slot); ?>
...
<?php /**PATH C:\xampp\htdocs\pilketos\resources\views/vendor/adminlte/components/widget/card.blade.php ENDPATH**/ ?>
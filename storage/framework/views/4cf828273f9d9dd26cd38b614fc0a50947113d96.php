...
<body class="<?php echo $__env->yieldContent('classes_body'); ?>" <?php echo $__env->yieldContent('body_data'); ?>>
    ...
    <script>
        $(document).ready(function(){
            ...
            swalSuccess('Success', '<?php echo e(session("success")); ?>');
            <?php endif; ?>

            <?php if(session()->has('error')): ?>
            swalError('Error', '<?php echo e(session("error")); ?>');
            <?php endif; ?>
        });
    </script>
</body>
...
<?php /**PATH C:\xampp\htdocs\pilketos\resources\views/vendor/adminlte/master.blade.php ENDPATH**/ ?>
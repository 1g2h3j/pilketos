...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card mb-3" style="max-width: 600px;">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="<?php echo e(asset('images/static/user-profile.png')); ?>" class="img-fluid rounded-start p-2" alt="user-profile">
          </div>
          <div class="col-md-8">
            <div class="card-body">
                <div class="name mt-3">
                <h3 class="name"><strong><?php echo e(Auth::user()->name); ?></strong></h3>
                <h6 class="type text-uppercase"><strong><?php echo e(Auth::user()->user_type); ?></strong></h6>
                </div>
                <div class="data mt-3">
              <p class="card-text m-0"><strong>NIS/NIP :</strong><span class="fst-italic"> <?php echo e(Auth::user()->uuid); ?></span></p>
        ...
        <div class="row p-3 pt-0">
            ...
            <div class="col-md-6 text-md-end"><form action="<?php echo e(route('agreement')); ?>" method="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pilketos\resources\views/profile.blade.php ENDPATH**/ ?>